...
#define DIFICULTAD_FACIL 1000
#define DIFICULTAD_MEDIA 500
#define DIFICULTAD_DIFICIL 250
#define DIFICULTAD_INCREMENTAL 1000
...
int CompruebaVidas (tipo_arkanoPi arkanoPi);
//------------------------------------------------------
